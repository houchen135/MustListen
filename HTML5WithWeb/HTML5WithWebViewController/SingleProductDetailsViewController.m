//
//  SingleProductDetailsViewController.m
//  MustListen
//
...
@interface SingleProductDetailsViewController ()<UIWebViewDelegate>
@property (nonatomic,strong)UIWebView *webView;
@end

@implementation SingleProductDetailsViewController
...
- (void)creatUi{
    ...
    NSURL *url =[[NSURL alloc]initWithString:[NSString stringWithFormat:@"%@%@%@",BaseUrl,H5PageUrlProduct,self.urlId]];
